...
;(function () {
  ...
  function dblik(e) {
    ...
    for (var j = 1; j < changdu; j++) {
      xianx =
        (points[select].p[j].x - yuanX) * Math.cos(((2 * Math.PI) / 360) * 45) -
        (points[select].p[j].y - yuanY) * Math.sin(((2 * Math.PI) / 360) * 45) +
        yuanX
      xiany =
        (points[select].p[j].x - yuanX) * Math.sin(((2 * Math.PI) / 360) * 45) +
        (points[select].p[j].y - yuanY) * Math.cos(((2 * Math.PI) / 360) * 45) +
        yuanY
      points[select].p[j].x = xianx
      points[select].p[j].y = xiany

      xianx2 =
        (points2[select].p[j].x - yuanX2) *
          Math.cos(((2 * Math.PI) / 360) * 45) -
        (points2[select].p[j].y - yuanY2) *
  ...
  function anglecompult(anglepostions, x, y) {
    //判断三角形内
  ...
  function reactcompult(reactpostions, x, y) {
    //判断鼠标是否在矩形区域内
